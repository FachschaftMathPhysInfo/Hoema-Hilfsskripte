...
% {Aufgabe} definiert einen neuen counter für Aufgaben
\renewcommand{\theExercise}{\thechapter.\Alph{Exercise}}
% ändert die Nummerierung von 0.1, 0.2, 1.1... zu 0.A, 0.B, 1.A... um sie leichter von Def, Theorem etc zu unterscheiden
...
% Weil die Standard \exists und \forall Symbole immer so aussehen wie Menschen in einem überfüllten Zug
% Die \let\... Zeile verhindert eine unendliche rekursive Ausführung
\let\squeezedexists\exists
\renewcommand{\exists}{\kern4pt\squeezedexists\kern2pt}
\let\squeezedforall\forall
\renewcommand{\forall}{\kern4pt\squeezedforall\kern2pt}
...
\newcommand{\e}{\text{\scalebox{1.1}{$\not \hspace{-2pt}\text{\footnotesize{O}}\hspace{1pt}$}}}
% da saß ich auch mindestens 1h dran um das leere Menge genau so hinzubasteln wie ich es haben wollte
% honourable mention to \cancel{\text{O}}
...
\newcommand{\absurdum}{{\hspace{12pt}\huge$\lightning$}}
% ein schöner "Widerspruch" Blitz, macht aber die Zeile in der er ist etwas höher
\renewcommand{\qedsymbol}{$\blacksquare$}
\newcommand{\subqed}{\hfill$\diamond$}
\newcommand{\notiff}{\iff\hspace{-17pt}\not\hspace{17pt}} % da hat es tatsächlich standardmäßig nichts
\newcommand{\limm}{\lim\limits_{n \rightarrow \infty}}
\newcommand{\limmsup}{\limsup\limits_{n \rightarrow \infty}}
\newcommand{\limminf}{\liminf\limits_{n \rightarrow \infty}}


% die 4 hier sind glaube ich nicht von mir, sondern noch von meinem Prof. Muss noch überprüfen was die machen und ob es schönere Symbole dafür gibt
